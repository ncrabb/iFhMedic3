...
@protocol DismissHistoryDelegate <NSObject>
...
@interface HistoryViewController : UIViewController <DismissValidateControl>
{
    __weak id <DismissHistoryDelegate> delegate;
}
