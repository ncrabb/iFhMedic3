...
+ (void) addToPreviewLayer:(AVCaptureVideoPreviewLayer *) videoPreviewLayer
{
  ...
  //  viewportLayer.frame = CGRectMake(110, 140, videoPreviewLayer.frame.size.width -240, videoPreviewLayer.frame.size.height - 300);
    viewportLayer.frame = CGRectMake(110, 140, videoPreviewLayer.frame.size.width - 200, videoPreviewLayer.frame.size.height - 300);
