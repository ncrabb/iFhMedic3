...
-->
                            ...
                            <xsl:if test="PCR/ID1113 != ''">
                                <td>
                                    <b>Responsible Party: </b><xsl:value-of select ="PCR/ID1113"/>, <xsl:value-of select ="PCR/ID1114"/>&#x0020;
					...
					<xsl:if test="PCR/ID1611 != ''">
						<b> Musculoskeletal - </b>
						<xsl:value-of select ="PCR/ID1611"></xsl:value-of>
					</xsl:if>
					<xsl:if test="PCR/ID1613 != ''">
						<b> Surgical - </b>
						<xsl:value-of select ="PCR/ID1613"></xsl:value-of>
					</xsl:if>
					<xsl:if test="PCR/ID1614 != ''">
						<b> Immunizations - </b>
						<xsl:value-of select ="PCR/ID1614"></xsl:value-of>
					</xsl:if>
					<xsl:if test="PCR/ID1631 != ''">
						<b> Last Tetanus - </b>
						<xsl:value-of select ="PCR/ID1631"></xsl:value-of>
					</xsl:if>
					<xsl:if test="PCR/ID1623 != ''">
						<b> Advanced Directive - </b>
						<xsl:value-of select ="PCR/ID1623"></xsl:value-of>
					</xsl:if>
                ...
                <div style="width:100%; float:left; text-align :left; overflow: auto; border-width: 1; border: ridge; font:90%">
					...
					<xsl:when test="PCR/MultiAssessment = '1'">
						<xsl:for-each select="PCR/Assessment">
							...
							<xsl:if test="ID1800 != ''">
								<b> Time - </b>
								<xsl:value-of select ="ID1800"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1801 != ''">
								<b> Skin - </b>
								<xsl:value-of select ="ID1801"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1802 != ''">
								<b> Head/Face - </b>
								<xsl:value-of select ="ID1802"></xsl:value-of>
							</xsl:if>

							<xsl:if test="ID1803 != ''">
								<b> Neck - </b>
								<xsl:value-of select ="ID1803"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1804 != ''">
								<b> Chest/Lungs - </b>
								<xsl:value-of select ="ID1804"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1805 != ''">
								<b> Heart - </b>
								<xsl:value-of select ="ID1805"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1806 != ''">
								<b> LU Abdomen - </b>
								<xsl:value-of select ="ID1806"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1807 != ''">
								<b> LL Abdomen - </b>
								<xsl:value-of select ="ID1807"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1808 != ''">
								<b> RU Abdomen - </b>
								<xsl:value-of select ="ID1808"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1809 != ''">
								<b> RL Abdomen - </b>
								<xsl:value-of select ="ID1809"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1810 != ''">
								<b> GU - </b>
								<xsl:value-of select ="ID1810"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1811 != ''">
								<b> Back Cervical - </b>
								<xsl:value-of select ="ID1811"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1812 != ''">
								<b> Back Thoracic - </b>
								<xsl:value-of select ="ID1812"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1813 != ''">
								<b> Back Lumbar - </b>
								<xsl:value-of select ="ID1813"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1814 != ''">
								<b> RU Extremities - </b>
								<xsl:value-of select ="ID1814"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1815 != ''">
								<b> RL Extremities - </b>
								<xsl:value-of select ="ID1815"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1816 != ''">
								<b> LU Extremities - </b>
								<xsl:value-of select ="ID1816"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1817 != ''">
								<b> LL Extremities - </b>
								<xsl:value-of select ="ID1817"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1818 != ''">
								<b> Left Eye - </b>
								<xsl:value-of select ="ID1818"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1819 != ''">
								<b> Right Eye - </b>
								<xsl:value-of select ="ID1819"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1820 != ''">
								<b> Mental Status - </b>
								<xsl:value-of select ="ID1820"></xsl:value-of>
							</xsl:if>
							<xsl:if test="ID1821 != ''">
								<b> Neuro - </b>
								<xsl:value-of select ="ID1821"></xsl:value-of>
							</xsl:if>
					...
					<xsl:if test="PCR/MultiAssessment != '1'">
					...
					<b> Severity - </b>
					<xsl:value-of select ="PCR/ID1214"/>&#x0020;
                    <b> Time - </b>
...
<!--
       ...
       <!--         <br/>-->
                <div style="border:ridge; font:90%; text-align:left; padding:5px">
                <div style="width=100%; text-align :left ; font-size: 120%;background: #ececec;color: black">
                    <b>Comments</b>
                </div >
    ...
    -->            
                ...
                <div style="border:ridge; font:90%; text-align:left">
                    ...
                    <table style="width=98%; font:85%">
                        <tr>
							...
							<xsl:if test="PCR/ID1050 != ''">
								<td>
									<b>Run Type: </b>
									<xsl:value-of select ="PCR/ID1050" />
								</td>
							</xsl:if >
                        </tr>
						...
						<xsl:if test="PCR/UnitsOnScene = '1'">
							<tr>
								...
								<xsl:for-each select="PCR/UnitOnScene">
									...
									<b> Unit 
										<xsl:value-of select ="ID1750"></xsl:value-of>
									</b>
									<xsl:value-of select ="ID1751"></xsl:value-of> &#160;
									<xsl:value-of select ="ID1752"></xsl:value-of> &#160;
									<xsl:value-of select ="ID1753"></xsl:value-of> &#160;
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="PCR/ID1401 = 'Patient Transported' or PCR/ID1401 = 'Non Emergency Transfer'">
							...
							<xsl:if test="PCR/ID1032 != ''">
								<b>Trauma Category - </b>
								<xsl:value-of select ="PCR/ID1032"></xsl:value-of>&#160;
							</xsl:if>
							...
							<xsl:if test="PCR/ID1423 != ''">
								<b> Condition on Arrival - </b>
								<xsl:value-of select ="PCR/ID1423"></xsl:value-of>
							</xsl:if>
                ...
                <div style="border:ridge; font:90%; text-align:left">
                    ...
                    <xsl:for-each select="PCR/Signature">
                        ...
                        <div style="display: inline; text-align:center; width:270px; height:85px">
